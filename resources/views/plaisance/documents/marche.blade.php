...
<head>
    ...
    <title>Marché Public - {{ $demande->titre }}</title>
    <style>
        body {
        ...
        /* Styles spécifiques pour le marché public */
        .marche-info {
            background-color: #e8f5e8;
...
<body>
    <div class="container">
        ...
        @if(!empty($marcheChamps))
        <div class="form-section">
            <table class="form-table">
                @php $counter = 0; @endphp
                @foreach($marcheChamps as $key => $champ)
                        ...
                        @endif
                                ...
                                <td class="value">
                                    @if(is_array($champ['value']))
                                        {{ implode(', ', $champ['value']) }}
                                    @elseif(is_numeric($champ['value']) && (strpos($key, 'montant') !== false || strpos($key, 'prix') !== false || strpos($key, 'cout') !== false || strpos($key, 'budget') !== false))
                                    ...
                                    @elseif(strpos($key, 'duree') !== false || strpos($key, 'delai') !== false)
        ...
        <div class="signature-section">
            <div class="signature-row">
                <div class="signature-box">
                    <div class="title">Signature du Maître d'Ouvrage</div>
                ...
                <div class="signature-box">
                    <div class="title">Signature de l'Entrepreneur</div>
                    <div class="signature-line"></div>
                    <div class="date-field-signature">Date: _______________</div>
                    <div class="date-field-signature">Nom et Fonction: _______________</div>
                </div>
