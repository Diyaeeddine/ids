...
<td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
    <div class="flex gap-4 w-full">
        ...
        {{-- Bouton Remplir avec condition --}}
        @if($demande->etape === 'acceptee')
            {{-- Demande acceptée - Bouton Remplir bloqué (déjà rempli) --}}
            <span class="inline-flex items-center px-3 py-1 bg-gray-400 text-white text-sm rounded-md cursor-not-allowed opacity-75">
                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @else
            {{-- Demande non acceptée - Bouton Remplir actif --}}
        ...
        {{-- Afficher le bouton Documents seulement si etape = acceptee --}}
        @if($demande->etape === 'acceptee')
