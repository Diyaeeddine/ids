      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
            ...
            <x-nav-link :href="route('tresorier.op')" :active="request()->routeIs('tresorier.op') || request()->routeIs('tresorier.create-OP') || request()->routeIs('op.demandes')">
              {{ __('Ordre de paiement') }}
            </x-nav-link>
            <x-nav-link :href="route('tresorier.ov')" :active="request()->routeIs('tresorier.ov') || request()->routeIs('tresorier.create-OV')">
      ...
      return {
        ...
        notifications: Array.isArray(initialNotifications)
          ? initialNotifications.map(n => ({
              ...
              source_user_id: n.source_user_id || n.user_id || null
          }))
          : [],
