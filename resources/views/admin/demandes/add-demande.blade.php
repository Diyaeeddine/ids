                ...
                <div class="flex flex-col md:flex-row justify-between items-end gap-4 mb-4"> 
                    ...
                    <div class="w-full md:w-64">
                        ...
                        <select name="type_economique" id="type_economique"
                            class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 px-3 py-2 shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" required>
